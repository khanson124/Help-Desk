...
namespace Help_Desk
{
    public partial class AgentTicketView : Form
    {
        ...
        public AgentTicketView(MainContainer mainContainer, int userID, string userRole)
        {
            InitializeComponent();
        ...
        {
            FrmFileAgentTicket frmFileTicket = new FrmFileAgentTicket();
            frmFileTicket.CurrentUserID = this.CurrentUserID;
            this.mainContainer.ShowFormInPanel(frmFileTicket);  // use class level mainContainer directly
            this.Hide();
        }
